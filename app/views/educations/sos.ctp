...
?>
    <div class="sos_div">
        ...
        <div class="info">
            ...
            <div class="content">
                <p><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'educations','action'=>'view_sos',$post['Post']['id'])); ?></p>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more comments',array('controller'=>'educations','action'=>'view_sos',$post['Post']['id'])); ?>
            </div>
            <div class="option-menu">
                <nav class="options">
                    <ul>
                        ...
                        <li><?php echo $this->Html->image("like-icon.png", array("alt" => "profile", 'url' => array('controller' => 'educations', 'action' => 'index'))); ?></li>
                    </ul>
                </nav>
