...
?>
    <div class="sos_div content-div">
        ...
        <div class="info">
            ...
            <div class="content">
                <p><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'educations','action'=>'view_advice',$post['Post']['id'])); ?></p>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View Advice',array('controller'=>'educations','action'=>'view_advice',$post['Post']['id'])); ?>
            </div>
