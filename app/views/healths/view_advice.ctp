...
<?php foreach ($comments as $comment) { ?>                       
    ...
    if ($this->Session->read('User.User.user_group_id') == '1') {
        ...
        <div class="add-comment">
            <?php
            echo $form->create('Advice', array('url' => array('controller' => 'healths', 'action' => 'add_advice_reply')));
        ...
        <div class="add-comment">
            <?php
            echo $form->create('Comment', array('url' => array('controller' => 'healths', 'action' => 'add_comment')));
            echo $form->hidden('post_id', array('value' => $post['Post']['id']));
            echo $form->hidden('user_id', array('value' => $this->Session->read('User.User.id')));
            echo $form->hidden('type', array('value' => $post['PostDetail']['type']));
...
<script>
    ...
    $(document).ready(function(){
        $('.like').click(function(){
            ...
            $.post("<?php echo $this->base; ?>/healths/add_beat",{
