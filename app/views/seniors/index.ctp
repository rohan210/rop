...
?>
    <div class="sos_div content-div">
        ...
        <div class="title">
            ...
            echo $this->Html->image("drop-down.png", array("alt" => "drop", 'url' => array('controller' => 'seniors', 'action' => 'index'))); 
            ?>
        ...
        <div class="info">
            ...
            <div class="content">
                ...
                <?php echo $this->Html->link('Read More',array('controller'=>'seniors','action'=>'view',$post['Post']['id'])); ?>
            </div>
            <div class="option-menu">
                <nav class="options">
                    <ul>
                        ...
                        <li><?php echo $this->Html->image("like-icon.png", array("alt" => "profile", 'url' => array('controller' => 'seniors', 'action' => 'index'))); ?></li>
                    </ul>
                </nav>
...
<?php echo $this->Html->image("center-profile-pic.jpg"); ?>
        ...
        <div class="option-menu">
            <nav class="options">
                <ul>
                    <li><?php echo $this->Html->image("comment-icon.png", array("alt" => "profile", 'url' => array('controller' => 'seniors', 'action' => 'index'))); ?></a>
                        <ul class="points">
                            <li>
