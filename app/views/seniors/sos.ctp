...
?>
    <div class="sos_div">
        ...
        <div class="info">
            ...
            <div class="content">
                <p><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'seniors','action'=>'view_sos',$post['Post']['id'])); ?></p>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more comments',array('controller'=>'seniors','action'=>'view_sos',$post['Post']['id'])); ?>
            </div>
