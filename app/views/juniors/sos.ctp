...
?>
    <div class="sos_div">
        ...
        <div class="info">
            ...
            <div class="content">
                <p><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'juniors','action'=>'view_sos',$post['Post']['id'])); ?></p>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more comments',array('controller'=>'juniors','action'=>'view_sos',$post['Post']['id'])); ?>
            </div>
            ...
            <div class="option-menu">
                <nav class="options">
                    <ul>
                        ...
                        <li><?php echo $this->Html->image("beat-off.png", array("alt" => "profile", 'url' => array('controller' => 'juniors', 'action' => 'index'))); ?></li>
                    </ul>
                </nav>
            </div>
            </div>
