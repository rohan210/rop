        ...
        <div class="info">
            ...
            <div class="content">
                ...
                if ($post['PostDetail']['type'] == 'sos') {
                    echo $this->Html->link($post['Post']['topic'], array('controller' => 'juniors', 'action' => 'view_sos', $post['Post']['id']));
                } 
                elseif ($post['PostDetail']['type'] == 'expert advice') {
                    echo $this->Html->link($post['Post']['topic'], array('controller' => 'juniors', 'action' => 'view_advice', $post['Post']['id']));
                }
                else{
