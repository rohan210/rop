    ...
    <div class="sos_div content-div">
        ...
        <div class="info">
            ...
            if ($post['PostDetail']['type'] == 'sos') {
                ...
                ?></h4>
                <p><?php echo $this->Text->truncate($post['Post']['post'], '150', array('ellipsis' => '...', 'exact' => false,'html'=>false)); ?></p>
            ...
            <div class="option-menu">
             ...
             ?></li>
                        ...
                        <li><?php echo $this->Html->image("share-icon.png", array("alt" => "share-icon", 'url' => array('controller' => 'cookings', 'action' => 'index'))); ?></li>
