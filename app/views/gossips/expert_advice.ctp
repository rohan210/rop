    ...
    <div class="sos_div content-div">
        ...
        <div class="info">
            ...
            <div class="content">
                ...
                <?php echo $this->Html->link('Read More',array('controller'=>'gossips','action'=>'view',$post['Post']['id'])); ?>
            </div>
...
<?php echo $this->Html->image("center-profile-pic.jpg"); ?>
        ...
        <div class="option-menu">
            <nav class="options">
                <ul>
                    <li><?php echo $this->Html->image("comment-icon.png", array("alt" => "profile", 'url' => array('controller' => 'gossips', 'action' => 'index'))); ?></a>
                        <ul class="points">
                            <li>
