...
?>
    <div class="sos_div">
        ...
        <div class="info">
            ...
            <div class="content">
                <p><?php echo $this->Html->link($post['Post']['topic'],array('controller'=>'natures','action'=>'view_sos',$post['Post']['id'])); ?></p>
    ...
    $i++;
                ...
                <?php echo $this->Html->link('View more comments',array('controller'=>'natures','action'=>'view_sos',$post['Post']['id'])); ?>
            </div>
